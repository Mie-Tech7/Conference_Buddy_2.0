    ...
    return (
        <div className="min-h-screen flex flex-col relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-1/4 -left-40 w-96 h-96 bg-primary-500/20 rounded-full blur-3xl animate-float animation-delay-200" />
            </div>
                    ...
                    <div className="glass-card rounded-3xl p-8 animate-slide-up">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-white/60">
                                Sign in to unlock your personalized conference experience
                            </p>
                        </div>
                        ...
                        <div className="space-y-4 mb-8">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    {INDUSTRIES.map((ind) => (
                                        <option key={ind} value={ind.toLowerCase().replace(/\s+/g, "-")} className="bg-gray-900">
                                            {ind}
                                        </option>
                                    ))}
                                </select>
                        ...
                        <div className="relative mb-8">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-4 bg-[var(--background)] text-white/40">
                                    Continue with
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <button
                                ...
                                className="oauth-btn disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {isLoading === "linkedin" ? (
                        ...
                        <p className="mt-8 text-center text-xs text-white/40">
                            ...
                            <a href="#" className="text-secondary-400 hover:underline">Terms of Service</a>
                            {" "}and{" "}
                            <a href="#" className="text-secondary-400 hover:underline">Privacy Policy</a>
                        </p>
                    </div>
                </div>
            </main>
            ...
            {/* Footer */}
            <footer className="relative z-10 p-4 text-center text-sm text-white/40">
                © 2024 Conference Buddy. All rights reserved.
            </footer>
        </div>
    );
}
